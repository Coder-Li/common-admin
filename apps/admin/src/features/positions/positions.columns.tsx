...
export interface PositionColumnLabels {
  actions: string
  code: string
  delete: string
  description: string
...
export interface PositionRowActions {
  canDelete: boolean
  canUpdate: boolean
...
function statusLabel(position: PositionRecord, labels: PositionColumnLabels) {
...
export function createPositionColumns(
  ...
  actions: PositionRowActions,
): ColumnDef<PositionRecord>[] {
  return [
    {
      accessorKey: 'name',
      header: labels.name,
